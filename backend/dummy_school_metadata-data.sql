...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '0fada9e6-0c48-11f1-9610-0a165d2dd0cf:1-51';
...
--
-- Table structure for table `students_legacy_archive`
--

DROP TABLE IF EXISTS `students_legacy_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `students_legacy_archive` (
  `id` int NOT NULL AUTO_INCREMENT,
  `admission_no` varchar(10) NOT NULL,
  `first_name` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `admission_no` (`admission_no`),
  KEY `idx_active_admission_id` (`id`,`admission_no`,`is_active`),
  KEY `idx_admission_date_no` (`admission_no`,`date_of_admission`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `students_legacy_archive`
--

LOCK TABLES `students_legacy_archive` WRITE;
/*!40000 ALTER TABLE `students_legacy_archive` DISABLE KEYS */;
INSERT INTO `students_legacy_archive` VALUES (1,'xxx','Unnati','Dinesh','Patil','1998-11-22','F','2025-07-21','Darshana','06969696969','unnati.patil@email.com','Tarak Smruti, Gnsl Gaon, Gnsl - W, 701','Ghansoli','Maharashtra','400701','None','2025-07-23 21:33:24','2026-03-18 15:11:18',NULL,0),(2,'000001','Anupama','Rana','DCruz','2020-12-16','F','2025-05-16','Sabu','8958356578','rana.dcruz-1421@gmail.com','Apt. 396 Jl. Kartini No. 17, Mamberamo Tengah, Srinagar, Tamil Nadu, 33755','Srinagar','Tamil Nadu','033755','None','2025-07-24 10:13:17','2025-07-24 10:13:17',NULL,1),(3,'000002','Gurdeep','Sarthak','Patil','2020-04-05','M','2025-06-01','Sayali','9032778693','sarth_patil81@hotmail.com','108/864, Motilal Ngr No 1, Goregaon (w)','Mumbai','Maharashtra','400104','None','2025-07-24 10:23:15','2025-07-24 10:23:15',NULL,1),(5,'000003','Rakesh','Raghu','Gupta','2021-04-03','M','2025-06-19','Sarika','7316485164','Raghu71.Gupta23@mail.com','E-8,0/1, Vardhaman Market, Sector 1, Vashi, Navi Mumbai','Vashi','Maharashtra','400705','None','2025-07-24 10:26:56','2025-07-24 10:26:56',NULL,1),(6,'000004','Shubham','Navneet','Rao','2018-05-01','M','2024-05-01','Anita','9282655877','navnneet.b.rao25@outlook.com','6, Dalvi Estate, B P Cross Road No 5, Bhayander (e)','Mumbai','Maharashtra','401105','None','2025-07-24 10:31:35','2025-07-24 10:31:35',NULL,1),(7,'000005','Dhaval','Anand','Anand','2021-07-10','M','2024-05-01','Anita','7006460453','anand.r.anand@yahoo.com','Shop No A 624, Muslim Nagar, 60 Feet Road, Dharavi','Mumbai','Maharashtra','400017','None','2025-07-24 10:40:25','2025-07-24 10:40:25',NULL,1),(8,'000006','Hafsa','Asrif','Begum','2020-12-03','F','2024-07-10','Yasmeen','7006460453','asril.begum83@gmail.com','Shop No A 624, Muslim Nagar, 60 Feet Road, Dharavi','Mumbai','Maharashtra','400017','None','2025-07-24 10:42:41','2025-07-24 11:05:57',NULL,1),(9,'000007','Hemant','Randive','Chaudhary','2019-03-12','M','2023-07-10','Preeti','8106460496','preeti.chaudhary@gmail.com','21, Vikrant Bldg, R.b.mehta Rd, Opp Bnk Of Madurai, Ghatkoper (east)','Mumbai','Maharashtra','400089','Hearing','2025-07-24 11:08:42','2025-07-24 11:11:02',NULL,1),(11,'000008','Banvi','Uncleji','More','2020-12-02','F','2025-07-10','Auntiji','9206460882','uncle.aunty@email.com','Shukla Compound, Behram Baug, Link Road, Jogeshwari(w)','Mumbai','Maharashtra','400102','Learning','2025-07-24 11:10:23','2025-09-08 20:25:25',NULL,1),(13,'000009','Anupama','Rana','DCruz','2020-12-15','F','2025-05-15','Sabu','8958356578','rana.dcruz-1421@gmail.com','Apt. 396 Jl. Kartini No. 17, Mamberamo Tengah, Srinagar, Tamil Nadu, 33755','Srinagar','Tamil Nadu','033755','None','2025-07-27 16:53:20','2025-07-27 16:53:20',NULL,1),(14,'000111','Surbhi','Papa','Jhuti','2021-08-16','F','2025-08-13','Mummy','321654789',NULL,'Changni Chowk, West','Insta','Mesopotania','444125','None','2025-08-26 21:56:12','2025-10-10 14:11:26',NULL,1),(15,'000012','From','Front','End','2025-08-05','M','2025-08-03','','aa',NULL,'','','','',NULL,'2025-08-26 22:12:57','2026-03-18 15:11:18',NULL,0),(16,'000010','Fareeha','Harinder','Gulrukh','2020-09-08','F','2025-05-13','Minali','9159264873',NULL,'ngni Chowk, West, Bangalore','Bangalore','Karnataka','560064','None','2025-09-08 20:38:57','2025-09-08 20:38:57',NULL,1),(21,'000011','Gurdeep','Raghu','Rao','2020-07-10','M','2025-05-13','Minali','9159271873',NULL,'Varalakshmicplxhosprdyelablr-64, Hospital Road, Mumbai','Mumbai','Maharashtra','160064','None','2025-10-08 20:38:57','2025-10-08 20:38:57',NULL,1),(23,'000013','Fareeha','Farinder','Hulrukh','2020-09-08','F','2025-05-13','Minali','9159264873',NULL,'Varaicplxhos, Market Road, Madurai','Madurai','Tamil Nadu','560064','Learning','2025-09-08 20:38:57','2025-09-08 20:38:57',NULL,1),(24,'000014','Mateha','Garinder','Mulrukh','2020-07-08','F','2025-05-13','Binali','9159264873',NULL,'Varshmicplabl, Pipeline Road, Bagha','Bagha','Goa','260064','None','2025-06-08 20:38:57','2026-03-18 15:11:18',NULL,0),(25,'000015','Bareha','Marinder','Fulrukh','2020-09-08','F','2025-05-13','Pinali','9159264873',NULL,'Vshmicplxhordyelr, Tulsi Road, Vishakapatnum','Vishakapatnum','Andhra Pradesh','360064','None','2025-05-08 20:38:57','2025-05-08 20:38:57',NULL,1),(26,'000016','Lareeha','Barinder','Bulrukh','2020-02-08','F','2025-05-13','Sinali','9159264873',NULL,'Alakshmicplxholr, Muhammed Ali Road, Jabalpur','Jabalpur','Madhya Pradesh','460064','Visual','2025-11-08 20:38:57','2025-11-08 20:38:57',NULL,1),(27,'000017','Pareha','Tarinder','Pulrukh','2020-11-08','F','2025-05-13','Minali','9159264873',NULL,'Varakshmicpelablr, Back Road, Mangalore','Mangalore','Karnataka','660064','None','2025-09-18 20:38:57','2025-09-18 20:38:57',NULL,1),(28,'000018','Tabeeha','Sarinder','Falrukh','2020-10-08','F','2025-05-13','Kinali','9159264873',NULL,'Varardyelablr, Side Road, Patna','Patna','Bihar','140064','None','2025-04-28 20:38:57','2026-03-18 15:11:18',NULL,0),(31,'000019','Safeeha','Yarinder','Tulrukh','2020-07-08','F','2025-05-13','Jinali','9159264873',NULL,'Varalakshelablr, Front Road, Muzaffarpur','Muzaffarpur','Bihar','541064','Other','2025-10-18 20:38:57','2025-10-18 20:38:57',NULL,1);
/*!40000 ALTER TABLE `students_legacy_archive` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `teacher_contact_info` (
  ...
  CONSTRAINT `teacher_contact_info_ibfk_1` FOREIGN KEY (`teacher_info_id`) REFERENCES `teacher_info` (`id`)
...
CREATE TABLE `user_contact_info` (
  ...
  CONSTRAINT `user_contact_info_ibfk_1` FOREIGN KEY (`user_info_id`) REFERENCES `user_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-20 23:44:29
